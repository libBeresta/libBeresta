(:file "consts"
 :consts ((:name "TRUE"  :value "1" :ru "Истина" :en "Truth")
             (:name "FALSE" :value "0" :ru "Ложь" :en "False")
             (:name "OK"    :value "0" :ru "Ошибок нет" :en "No errors")
             (:name "PI"    :value "3.14159265358979323846" :ru "Число Пи" :en "Pi number")
             (:name "MM"    :value "2.834646" :ru "Предопределенное значение для вычислений в миллиметрах, равно 72.0/25.4 (72 точки на дюйм на мм)" 
              :en "Predefined value for calculations in millimeters, equals to 72.0/25.4 (72 points per inch per mm)")
             (:name "IN"    :value "72.00000" :ru "Предопределенное значение для вычислений в дюймах (72 точки на дюйм)" 
              :en "Predefined value for calculations in inches, equals to 72 points per inch"))

 :enums
       ((:name "GMode"
	 :ru "Графический режим, используемый для контроля вызова графических функций."
	 :en "Graphics mode, used to control graphical functions."
	 :elements ((:element "GMODE_PAGE_DESCRIPTION"
		     :ru "Режим разметки страницы"
		     :en "Page description (markup) mode"
		     :value "0x0001")
		    (:element "GMODE_PATH_OBJECT"
		     :ru "Режим работы с путями"
		     :en "Path creation mode"
		     :value "0x0002")
		    (:element "GMODE_TEXT_OBJECT"
		     :ru "Режим работы с текстами"
		     :en "Text creation mode"
		     :value "0x0004")
		    (:element "GMODE_CLIPPING_PATH"
		     :ru "Режим работы с отсечением"
		     :en "Clipping path creation mode"
		     :value "0x0008")
		    (:element "GMODE_SHADING"
		     :ru "Режим работы с затенением"
		     :en "Shading creation mode"
		     :value "0x0010")
		    (:element "GMODE_INLINE_IMAGE"
		     :ru "Режим работы с изображениями"
		     :en "Image creation mode"
		     :value "0x0020")
		    (:element "GMODE_EXTERNAL_OBJECT"
		     :ru "Режим работы с внешними объектами (XObject)"
		     :en "XObject creation mode"
		     :value "0x0040")))
	(:name "CompressionMode"
         :ru "Режим компрессии документа"
         :en "Document compression mode"
         :elements ((:element "COMP_MODE_NONE"
                     :ru "Без компрессии"
                     :en "No compression"
                     :value "0x00")
                    (:element "COMP_MODE_TEXT"
                     :ru "Сжимать текстовые словари"
                     :en "Compress text dictionaries"
                     :value "0x01")
                    (:element "COMP_MODE_IMAGE"
                     :ru "Сжимать изображения"
                     :en "Compress images"
                     :value "0x02")
                    (:element "COMP_MODE_METADATA"
                     :ru "Сжимать вложенные данные (только шрифты)"
                     :en "Compress nested metadata (fonts only)"
                     :value "0x04")
                    (:element "COMP_MODE_ALL"
                     :ru "Сжимать всё"
