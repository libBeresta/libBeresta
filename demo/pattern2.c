...
BRST_Pattern createPattern(BRST_Doc pdf, BRST_REAL degrees, BRST_REAL scale) {
...
int main(int argc, char** argv)
{
    ...
    BRST_Pattern p1 = createPattern(pdf,  0, 1.0f);
    BRST_Pattern p2 = createPattern(pdf,  0, 0.2f);
    BRST_Pattern p3 = createPattern(pdf, 70, 1.7f);
