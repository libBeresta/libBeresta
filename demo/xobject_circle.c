 ...
 * `libBeresta`
 *
 * xobject_circle.c - Составная функция (окружность) в XObject
 * ================
 *
...
/** en
  \par XObject Form creation and usage with circle
*/

/** ru
  \par Создание и отображение XObject Form с окружностью
*/
